...
#define MAX_CMD_SZ	7
extern char htc_speaker_vol_control[MAX_CMD_SZ];
extern char htc_headset_vol_control[MAX_CMD_SZ];
extern char htc_ring_vol_control[MAX_CMD_SZ];
extern char htc_handset_vol_control[MAX_CMD_SZ];
extern char htc_lineout_vol_control[MAX_CMD_SZ];
#ifdef CONFIG_SND_CONTROL_HAS_BEATS
extern char htc_beats_on_vol_control[MAX_CMD_SZ];
extern char htc_beats_off_vol_control[MAX_CMD_SZ];
#endif
